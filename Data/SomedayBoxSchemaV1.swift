...
public enum SomedayBoxSchemaV3: VersionedSchema {
    ...
    public final class ItemRecord {
        ...
        public var lastShownAt: Date?
        public init(id: UUID, title: String, note: String?, durationBucketRaw: String, lifecycleRaw: String, createdAt: Date, updatedAt: Date, completedAt: Date?, lastShownAt: Date?) {
            self.id = id; self.title = title; self.note = note; self.durationBucketRaw = durationBucketRaw; self.lifecycleRaw = lifecycleRaw; self.createdAt = createdAt; self.updatedAt = updatedAt; self.completedAt = completedAt; self.lastShownAt = lastShownAt
        }
    }
    ...
    public final class SessionRecord {
        ...
        public var presentationPresetRaw: String?
        public var policyVersion: String
        public init(id: UUID, startedAt: Date, endedAt: Date?, contextModeRaw: String, maximumMinutes: Int?, presentationPresetRaw: String?, policyVersion: String) {
            self.id = id; self.startedAt = startedAt; self.endedAt = endedAt; self.contextModeRaw = contextModeRaw; self.maximumMinutes = maximumMinutes; self.presentationPresetRaw = presentationPresetRaw; self.policyVersion = policyVersion
        }
    }
